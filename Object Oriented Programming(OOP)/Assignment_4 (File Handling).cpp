    ...
    void writeToFile()
{
	...
	outfile<<"Roll_number: "<<roll_no<<endl;
	outfile<<"Class: "<<class_<<endl;
	outfile<<"Division: "<<div<<endl;
	outfile<<"DOB: "<<dob<<endl;
	outfile<<"Blood Group: "<<blood<<endl;
	outfile<<"Telephone number: "<<tel<<endl;
	outfile<<"Driving License Number: "<<driv_no<<endl;
    outfile<<"Address is :"<<cont_add<<endl;
}
...
cout<<"________________________________________________________________________________________________________________________________________________________________________________________________________"<<endl;
        ...
        break;
            ...
            string read;
            input.open("dat.txt",ios::in);                            //Reading a file
              if(!input){
